...
public class MovingPlatformHorizontal : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        direction = new Vector2(startDirection, 0); // Move direction is on the x axis
    }
    ...
    {
        return this.transform.position.x > startPos.x + range && direction.x > 0
            || this.transform.position.x < startPos.x - range && direction.x < 0;
    }
